...
set val(cp)	links/cbr5.tcl		   ;# node link file
set val(out_tr)  "results/60nodes.tr"	   ;# output file of tracefd
set val(out_nam) "results/60nodes.nam"	   ;# output file of namtrace 
